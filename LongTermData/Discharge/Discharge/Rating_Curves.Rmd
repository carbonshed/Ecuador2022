...
df$stn1_Q <- 0.8823 - 10.3227 * df$lvl_421_m + 32.2560 * (df$stn1_Q)^2
```
...
df$stn2_Q <- 0.8823 - 10.3227 * df$lvl_421_m + 32.2560 * (df$lvl_421_m)^2
```
...
df$stn3_Q <- 0.3427 - 4.5198 * df$lvl_421_m + 17.0234 * (df$lvl_421_m)^2
```
...
df$stn4_Q <- 0.02759 - 1.43450 * df$lvl_421_m + 9.84825 * (df$lvl_421_m)^2
```
...
# Kriddie Model
df$stn4_Q <- (0.02759 - 1.43450 * df$lvl_421_m + 9.84825 * (df$lvl_421_m)^2)*1000
```
