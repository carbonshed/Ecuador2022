...
#WL_Wetland01 <- WL_Wetland01[!with(WL_Wetland01,is.na(WLPres_kpa)& is.na(WLTemp_c)),]

#test <-  WL_Wetland01[duplicated(WL_Wetland01$DateTime)|duplicated(WL_Wetland01$DateTime, fromLast=TRUE),]
...
#WL_Wetland12_corrected <- WL_Wetland%>%filter(Station=="WL_Wetland12")
