...
#write.csv(df_plot,here::here("ProcessedData/Inj_CO2_2022-07-01.csv"))
...
#write.csv(co2_table,here::here("Injections/2022-07-01/injection_co2_result.csv"))
...
#Discharge 
#Q at 0m
Q_0m = mean(c(92.12,91.13)) 
# Q for 50m 
Q_50m = mean(c(86.56,88.7)) 
...
# Slug One
#discharge at 50m; poured in salt at 12:04, peak at 12:13
...
#Slug Two
#missing peak time at 0m

kt = km * velocity_one #units (1/s)
kCO2_mperd <- kt*86400
  
print(c(velocity_one,kCO2_mperd))
```
