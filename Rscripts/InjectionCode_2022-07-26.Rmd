...
This Rmarkdown analyses data collected during an injection experiment on 2022-07-6
colmillo

### We start by reading in an then cleaning data, file 
Sensors in water: 10:30

CO2 injection start: 10:47
end: 12:20

Tank leaking so CO2 was stopped and started again
...
end <-  as.POSIXct("2022-07-26 17:00:00", tz = "UTC")
...
waterlevel_n10 <- read.csv("Injection_Temp_xn10m_2022-07-26.csv", skip = 1)
...
preplat_n10 <- filter(df_xn10m, DateTime >= as.POSIXct("2022-07-26 10:35:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 10:40:00", tz = "UTC"))
preplat_0 <- filter(df_x0m, DateTime >= as.POSIXct("2022-07-26 10:35:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 10:40:00", tz = "UTC"))
preplat_25 <- filter(df_x25m, DateTime >= as.POSIXct("2022-07-26 10:35:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 10:40:00", tz = "UTC"))
preplat_50 <- filter(df_x50m, DateTime >= as.POSIXct("2022-07-26 10:35:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 10:40:00", tz = "UTC"))
...
plat_n10 <- filter(df_xn10m, DateTime >= as.POSIXct("2022-07-26 12:17:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:27:00", tz = "UTC"))
plat_0 <- filter(df_x0m, DateTime >= as.POSIXct("2022-07-26 12:17:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:22:00", tz = "UTC"))
plat_25 <- filter(df_x25m, DateTime >= as.POSIXct("2022-07-26 12:22:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:27:00", tz = "UTC"))
plat_50 <- filter(df_x50m, DateTime >= as.POSIXct("2022-07-26 12:22:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:27:00", tz = "UTC"))
...
postplat_n10 <- filter(df_xn10m, DateTime >= as.POSIXct("2022-07-26 12:50:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:53:00", tz = "UTC"))

postplat_0 <- filter(df_x0m, DateTime >= as.POSIXct("2022-07-26 12:50:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:53:00", tz = "UTC"))

postplat_25 <- filter(df_x25m, DateTime >=  as.POSIXct("2022-07-26 12:50:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:53:00", tz = "UTC"))

postplat_50 <- filter(df_x50m, DateTime >=  as.POSIXct("2022-07-26 12:50:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:53:00", tz = "UTC"))
...
air_n10 <-filter(df_xn10m, DateTime >= as.POSIXct("2022-07-26 09:22:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 09:32:00", tz = "UTC"))
air_0 <-filter(df_x0m, DateTime >= as.POSIXct("2022-07-26 09:22:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 09:32:00", tz = "UTC"))
air_25 <-filter(df_x25m, DateTime >= as.POSIXct("2022-07-26 09:22:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 09:32:00", tz = "UTC"))
air_50 <-filter(df_x50m, DateTime >= as.POSIXct("2022-07-26 09:22:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 09:32:00", tz = "UTC"))
...
write.csv(co2_table,here::here("Injections/2022-07-26/injection_co2_result.csv"))
...
x0
Q = 125.41
Peak at 7/26/2022   11:51:28 AM

x25
Q = 143.53
peak at 7/26/2022  11:55:47 AM

x50
Q= 138.8
peak at 7/26/2022  11:57:27 AM
...
# Slug One
#discharge at 50m; poured in salt at 11:50 
# 0m Peak at  Peak at 7/26/2022   11:51:28 AM 
# 50m  peak at 7/26/2022  11:57:27 AM
#start: 1
# velocity in m/s
dist_salt = 50
diff_one <- (57 - 51)*60 + (27-28)
...
df_avg_water <- filter(df_corr, DateTime >= as.POSIXct("2022-07-26 10:30:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:50:00", tz = "UTC"))
...
```{r k600 at -10m}
# first, read in WL hobo at -10m 
flux_n10 <- read.csv(here::here("Injections/2022-07-26/Injection_Flux_xn10m_2022-07-26.csv"))
...
flux_n10 <- flux_n10%>%filter(Date == "2022-07-26")
...
backgrond_df <- filter(backgrond_df, DateTime >= as.POSIXct("2022-07-26 10:30:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 13:00:00", tz = "UTC"))
#add baro data because we need air temp

baro_n10 <- read.csv(here::here("Injections/2022-07-26/Injection_Baro_2022-07-26.csv"),skip = 1)[2:4]
...
##calculate k600
########
adjustment <-filter(baro_n10, DateTime >= as.POSIXct("2022-07-26 10:30:00", tz = "UTC") & DateTime < as.POSIXct("2022-07-26 12:50:00", tz = "UTC"))
