...
#boxplots galore
boxplot(log(df$pCO2_ppm)) ##transformed
hist(log(df$pCO2_ppm))
ggplot(df, aes(log(pCO2_ppm), num)) + geom_point()
...
grid_df$Var2[which(grid_df$Var2 == 1)] <- "depth_ave_m"
...
for (row in 2:nrow(grid_df)){
  ...
  if(length(f_2)==1){
    model <- lmer(
    as.formula(paste0("log(pCO2_ppm) ~ ","scale(",f_2[1],") + (1 |Site)")),
    ...
    model <- lmer(
      as.formula(paste0("log(pCO2_ppm) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(pCO2_ppm) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(pCO2_ppm) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(pCO2_ppm) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(pCO2_ppm) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(pCO2_ppm) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + scale(",f_2[7],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(pCO2_ppm) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + scale(",f_2[7],") + scale(",f_2[8],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
