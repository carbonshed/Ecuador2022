...
WL_df_extrapolate$FLUX_AIC_noW12 <- coeff_df[1,"Estimate"] +
...
WL_df_extrapolate$FLUX_BIC_noW12 <- coeff_df[1,"Estimate"] +
  WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"] +
  WL_df_extrapolate$waterTemp_c_yearly * coeff_df[3,"Estimate"] +
  WL_df_extrapolate$waterTemp_c_day * coeff_df[4,"Estimate"] +
  WL_df_extrapolate$SA_log * coeff_df[5,"Estimate"] +
...
WL_df_extrapolate$FLUX_AIC_W12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"] +
  WL_df_extrapolate$waterTemp_c_yearly * coeff_df[3,"Estimate"] +
  WL_df_extrapolate$waterTemp_c_day * coeff_df[4,"Estimate"] +
  WL_df_extrapolate$SA_log * coeff_df[5,"Estimate"] +
...
WL_df_extrapolate$FLUX_BIC_W12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"] +
...
WL_df_extrapolate$CO2_AIC_noW12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"] +
  WL_df_extrapolate$waterTemp_c_yearly * coeff_df[3,"Estimate"]  +
  WL_df_extrapolate$SA_log * coeff_df[4,"Estimate"] 
...
WL_df_extrapolate$CO2_BIC_noW12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"] 
...
WL_df_extrapolate$CO2_AIC_W12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"] +
  WL_df_extrapolate$waterTemp_c_yearly * coeff_df[3,"Estimate"]  +
  WL_df_extrapolate$SA_log * coeff_df[4,"Estimate"] 
...
WL_df_extrapolate$CO2_BIC_W12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"] +
  WL_df_extrapolate$waterTemp_c_yearly * coeff_df[3,"Estimate"]
...
WL_df_extrapolate$CH4_AIC_noW12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"]+
...
WL_df_extrapolate$CH4_BIC_noW12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"]+
   WL_df_extrapolate$Baro_Water_minus_air_Temp * coeff_df[3,"Estimate"]+
   WL_df_extrapolate$waterTemp_c_day * coeff_df[4,"Estimate"]
...
#AIC 
#(Intercept), scale(BaroTemp_c_yearly), scale(waterTemp_c_yearly), scale(Baro_Water_minus_air_Temp), scale(waterTemp_c_day)

M_CH4_AIC_W12 <- lmer(CH4_umol.L ~ 
                          scale(BaroTemp_c_yearly)+
                          scale(waterTemp_c_yearly) +
                          scale(Baro_Water_minus_air_Temp)+
                          scale(waterTemp_c_day) +
...
WL_df_extrapolate$CH4_AIC_W12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"]+
   WL_df_extrapolate$waterTemp_c_yearly * coeff_df[3,"Estimate"]+
...
WL_df_extrapolate$CH4_BIC_W12 <- coeff_df[1,"Estimate"] +
   WL_df_extrapolate$BaroTemp_c_yearly * coeff_df[2,"Estimate"]+
   WL_df_extrapolate$Baro_Water_minus_air_Temp * coeff_df[3,"Estimate"]+
   WL_df_extrapolate$waterTemp_c_day * coeff_df[4,"Estimate"]
...
WL_df_extrapolate$FLUX_AIC_noW12_umol_15min <- WL_df_extrapolate$FLUX_AIC_noW12 * WL_df_extrapolate$surface_area_m2 * 60 *15 

WL_df_extrapolate$FLUX_BIC_noW12_umol_15min <- WL_df_extrapolate$FLUX_BIC_noW12 * WL_df_extrapolate$surface_area_m2 * 60 *15 

WL_df_extrapolate$FLUX_AIC_W12_umol_15min <- WL_df_extrapolate$FLUX_AIC_W12 * WL_df_extrapolate$surface_area_m2 * 60 *15

WL_df_extrapolate$FLUX_BIC_W12_umol_15min <- WL_df_extrapolate$FLUX_BIC_W12 * WL_df_extrapolate$surface_area_m2 * 60 *15 

#use CO2 and k models to calc flux
WL_df_extrapolate$FLUX_AIC_noW12_CALC_umol_15min 

WL_df_extrapolate$FLUX_BIC_noW12_CALC_umol_15min 

WL_df_extrapolate$FLUX_AIC_W12_CALC_umol_15min 

WL_df_extrapolate$FLUX_BIC_W12_CALC_umol_15min 
...
WL_df_extrapolate_monthSUMMARY <- WL_df_extrapolate%>%
  group_by(month,Wetland)%>% 
  summarise(
    FLUX_AIC_noW12_umol15min_monthAve = mean(FLUX_AIC_noW12_umol_15min, na.rm = TRUE),
    FLUX_BIC_noW12_umol15min_monthAve = mean(FLUX_BIC_noW12_umol_15min, na.rm = TRUE),
    FLUX_AIC_W12_umol15min_monthAve = mean(FLUX_AIC_W12_umol_15min, na.rm = TRUE),
    FLUX_BIC_W12_umol15min_monthAve = mean(FLUX_BIC_W12_umol_15min, na.rm = TRUE),
  )

WL_df_extrapolate_monthSUMMARY$FLUX_AIC_noW12_umol_monthSUM <- WL_df_extrapolate_monthSUMMARY$FLUX_AIC_noW12_umol15min_dayAve * 96 * 30

WL_df_extrapolate_monthSUMMARY$FLUX_BIC_noW12_umol_monthSUM <- WL_df_extrapolate_monthSUMMARY$FLUX_BIC_noW12_umol15min_dayAve * 96 *30

WL_df_extrapolate_monthSUMMARY$FLUX_AIC_W12_umol_montSUM <- WL_df_extrapolate_monthSUMMARY$FLUX_AIC_W12_umol15min_dayAve * 96 * 30

WL_df_extrapolate_monthSUMMARY$FLUX_BIC_W12_umol_monthSUM <- WL_df_extrapolate_monthSUMMARY$FLUX_BIC_W12_umol15min_dayAve * 96 * 30
...
WL_df_extrapolate_yearSUMMARY$FLUX_AIC_noW12_umol_year <- WL_df_extrapolate_yearSUMMARY$FLUX_AIC_noW12_umol_yearMEAN *365

WL_df_extrapolate_yearSUMMARY$FLUX_BIC_noW12_umol_year <- WL_df_extrapolate_yearSUMMARY$FLUX_BIC_noW12_umol_yearMEAN *365

WL_df_extrapolate_yearSUMMARY$FLUX_AIC_W12_umol_year <- WL_df_extrapolate_yearSUMMARY$FLUX_AIC_W12_umol_yearMEAN *365

WL_df_extrapolate_yearSUMMARY$FLUX_BIC_W12_umol_year <- WL_df_extrapolate_yearSUMMARY$FLUX_BIC_W12_umol_yearMEAN *365

WL_df_extrapolate_yearSUMMARY <- WL_df_extrapolate_yearSUMMARY[c("Wetland","FLUX_AIC_noW12_umol_year","FLUX_BIC_noW12_umol_year","FLUX_AIC_W12_umol_year","FLUX_BIC_W12_umol_year")]
library(reshape2)
...
p1 <- ggplot(data = WL_df_extrapolate, aes(x = DateTime, y = CH4_BIC_W12)) + 
  geom_point() 
