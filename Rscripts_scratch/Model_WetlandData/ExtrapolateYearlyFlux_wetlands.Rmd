...
WL_df$CH4_air_umol.L <- WL_df$Total_air_MolperL * CH4_air_ppmq *1000
```
...
WL_df_extrapolate$FLUX_AIC_noW12_CALC_umol_s <- WL_df_extrapolate$k_AIC_noW12 * (WL_df_extrapolate$CO2_AIC_noW12 - WL_df_extrapolate$CO2_air_umol.L) * WL_df_extrapolate$KH_CO2_mol.L.atm
...
WL_df_extrapolate$FLUX_AIC_W12_CALC_umol_s <- WL_df_extrapolate$k_AIC_W12 * (WL_df_extrapolate$CO2_AIC_W12 - WL_df_extrapolate$CO2_air_umol.L) * WL_df_extrapolate$KH_CO2_mol.L.atm
...
WL_df_extrapolate_yearSUMMARY$FLUX_AIC_W12_CALC_umol_year <- WL_df_extrapolate_yearSUMMARY$FLUX_AIC_W12_CALC_umol_yearMEAN *365

WL_df_extrapolate_yearSUMMARY$FLUX_AIC_noW12_CALC_umol_year <- WL_df_extrapolate_yearSUMMARY$FLUX_AIC_noW12_CALC_umol_yearMEAN *365

WL_df_extrapolate_yearSUMMARY <- WL_df_extrapolate_yearSUMMARY[c("Wetland","FLUX_AIC_noW12_umol_year","FLUX_BIC_noW12_umol_year","FLUX_AIC_W12_umol_year","FLUX_BIC_W12_umol_year","FLUX_AIC_noW12_CALC_umol_year","FLUX_AIC_noW12_CALC_umol_year")]
library(reshape2)
