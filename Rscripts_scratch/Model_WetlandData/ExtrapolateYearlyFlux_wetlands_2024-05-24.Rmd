...
#correct baropres for elevation
...
df_1 <- left_join(df_1,intercept_df,by="Site")

df_1$M_AICc_CH4 <- exp(
  df_1$intercept +
   df_1$waterTemp_c_yearly * coeff_df[2,"Estimate"] +
  log(df_1$SA_to_Vol_ratio) * coeff_df[3,"Estimate"] +
    df_1$percent_DTW * coeff_df[4,"Estimate"] +
    df_1$Elevation_m * coeff_df[5,"Estimate"] 
  )
...
df_1$M_BIC_CH4 <- exp(
  df_1$intercept +
  log(df_1$SA_to_Vol_ratio) * coeff_df[2,"Estimate"] +
    df_1$Elevation_m * coeff_df[3,"Estimate"]
  )
...
df_1$M_AICc_CO2 <- exp(
  df_1$intercept +
   df_1$WaterTemp_c * coeff_df[2,"Estimate"] +
    df_1$waterTemp_c_yearly * coeff_df[3,"Estimate"] +
        df_1$percent_DTW * coeff_df[4,"Estimate"] +
    df_1$Elevation_m * coeff_df[5,"Estimate"]
  )
...
df_1$M_BIC_CO2 <- exp(
  df_1$intercept +
      df_1$percent_DTW * coeff_df[2,"Estimate"] +
    df_1$Elevation_m * coeff_df[3,"Estimate"]
  )
