...
M1 <- lmer(k_m_d ~ scale(Watertemp_c) +
...
#grid_df$Var2[which(grid_df$Var2 == 1)] <- "temp_diff"
grid_df$Var2[which(grid_df$Var2 == 1)] <- "log(surface_area_m2)"
grid_df$Var3[which(grid_df$Var3 == 1)] <- "PrecipAccuDay_mm"
#grid_df$Var5[which(grid_df$Var5 == 1)] <- "solarrad_Wm2_daymean"
grid_df$Var4[which(grid_df$Var4 == 1)] <- "windspeed_m_s"
...
for (row in 2:nrow(grid_df)){
  ...
  if(length(f_2)==1){
    model <- lmer(
    as.formula(paste0("k_m_d ~ ","scale(",f_2[1],") + (1 |Site)")),
    ...
    model <- lmer(
      as.formula(paste0("k_m_d ~ ","scale(",f_2[1],") +scale(",f_2[2],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("k_m_d ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("k_m_d ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("k_m_d~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("k_m_d ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    
    Dataframe[nrow(Dataframe) + 1,] <- list(toString(rownames(summary$coefficients)), summary$AIC[1], summary$AIC[2], AICc(model))
      } else if(length(f_2)==7) { 
    model <- lmer(
      as.formula(paste0("k_m_d ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + scale(",f_2[7],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
...
#remove Wetland 12 for this analysis?
df_1 <- df%>%filter(Site!="Wetland12")
df_1 <- df_1%>%filter(DateTime < "2022-10-01 00:00:00")
...
for (row in 2:nrow(grid_df)){
  ...
  if(length(f_2)==1){
    model <- lmer(
    as.formula(paste0("K600 ~ ","scale(",f_2[1],") + (1 |Site)")),
    data = df_1,REML = FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("K600 ~ ","scale(",f_2[1],") +scale(",f_2[2],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("K600 ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("K600 ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("K600 ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("K600 ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    
    Dataframe[nrow(Dataframe) + 1,] <- list(toString(rownames(summary$coefficients)), summary$AIC[1], summary$AIC[2], AICc(model))
      } else { 
    model <- lmer(
      as.formula(paste0("K600 ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + scale(",f_2[7],") + (1 |Site)")),data=df_1,REML=FALSE)
    summary <- summary(model)
...
M1 <- lm(k_m_d ~ 
                  scale(log(surface_area_m2)) +
                  scale(solarrad_Wm2_daymean) , data =df_1,REML=FALSE)
...
M1 <- lm(k_m_d ~ 
                  scale(log(surface_area_m2)) +
                  scale(solarrad_W_m2) , data =df_1 ,REML=FALSE)
