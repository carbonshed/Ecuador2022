...
#remove Wetland 12?
df <- df_saved%>%filter(Wetland!="Wetland12")
...
for (row in 2:nrow(grid_df)){
  ...
  if(length(f_2)==1){
    model <- lmer(
    as.formula(paste0("log(CO2_umol.L) ~ ","scale(",f_2[1],") + (1 |Wetland)")),
    ...
    model <- lmer(
      as.formula(paste0("log(CO2_umol.L) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + (1 |Wetland)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(CO2_umol.L) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + (1 |Wetland)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(CO2_umol.L) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + (1 |Wetland)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(CO2_umol.L) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + (1 |Wetland)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(CO2_umol.L) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + (1 |Wetland)")),data=df_1,REML=FALSE)
    summary <- summary(model)
    ...
    model <- lmer(
      as.formula(paste0("log(CO2_umol.L) ~ ","scale(",f_2[1],") +scale(",f_2[2],") + scale(",f_2[3],") + scale(",f_2[4],") + scale(",f_2[5],") + scale(",f_2[6],") + scale(",f_2[7],") + (1 |Wetland)")),data=df_1,REML=FALSE)
    summary <- summary(model)
