...
grid_df$Var1[which(grid_df$Var1 == 1)] <- "BaroTemp_c_day"
...
#AIC: (Intercept), scale(BaroTemp_c_day), scale(log(surface_area_m2)), scale(precip_mm_ave2), scale(SA_to_Vol_ratio)
