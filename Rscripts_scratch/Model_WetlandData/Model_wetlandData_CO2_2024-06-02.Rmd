...
grid_df$Var3[which(grid_df$Var3 == 1)] <- "log(WS_area_minus_pond)"
...
#AICc: (Intercept), scale(Watertemp_c), scale(waterTemp_c_yearly), scale(percent_DTW), scale(Elevation_m), scale(log(surface_area_m2))

#	(Intercept), scale(Watertemp_c), scale(waterTemp_c_yearly), scale(log(WS_area_minus_pond)), scale(percent_DTW), scale(Elevation_m)
