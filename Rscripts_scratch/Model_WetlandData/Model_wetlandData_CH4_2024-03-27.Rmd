...
grid_df$Var5[which(grid_df$Var5 == 1)] <- "log(WS_area_minus_pond)"
grid_df$Var6[which(grid_df$Var6 == 1)] <- "percent_DTW"
grid_df$Var7[which(grid_df$Var7 == 1)] <- "precip_mm_ave2"
grid_df$Var8[which(grid_df$Var8 == 1)] <- "Elevation_m"
...
#without wetland 12 
#(Intercept), (Intercept), scale(Watertemp_c), scale(Elevation_m), scale(log(surface_area_m2)), scale(log(SA_to_Vol_ratio))
