...
plot_ly(data = WL_Wetland04, x = ~DateTime, y = ~WLPres_kpa)
```
##  Plot
...
p <- ggplot(data = WL_Wetland, aes(x = DateTime, y = WLPres_kpa)) + geom_point()
...
#select two data points - one before the logger was downloaded, and one after the logger was downloaded. Take an average of the two and report

DateTime_BEFORE <- "2022-07-14 09:45:00"
DateTime_AFTER <- "2022-07-14 10:00:00"
