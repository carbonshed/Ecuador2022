...
WL_Wetland09 <- WL_Wetland09%>%filter(DateTime > as.POSIXct("2022-07-05 11:30:00",tz="UTC"))%>%
  filter(DateTime < as.POSIXct("2022-07-08 10:00:00",tz="UTC")|
                                        DateTime > as.POSIXct("2022-07-08 10:45:00",tz = "UTC"))
...
plot_ly(data = WL_Wetland08, x = ~DateTime, y = ~WLPres_kpa)
```
##  Plot
plot all water level data

```{r merge and plot, echo=FALSE}
WL_Wetland <- rbind(WL_Wetland01,WL_Wetland02,WL_Wetland03,WL_Wetland04,WL_Wetland05,WL_Wetland06,WL_Wetland07,WL_Wetland08,WL_Wetland09,WL_Wetland10,WL_Wetland11)
...
wetland <- WL_Wetland08 #WL_Wetland01, WL_Wetland02
...
ave <- wetland %>%
  ...
  summarize(WaterlLevel_mean = mean(WLPres_kpa),
