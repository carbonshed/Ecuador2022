...
WL_Wetland02 <- WL_Wetland02%>%filter(DateTime != as.POSIXct("2023-06-20 11:45:00",tz = "UTC")&
  ...
  #string broke, bad data
WL_Wetland02 <- WL_Wetland02%>%filter(DateTime < as.POSIXct("2023-03-20 11:30:00",tz = "UTC"))
...
ggplot(data = WL_Wetland08, aes(x = DateTime, y = WLPres_kpa)) + geom_point()
ggplot(data = WL_Wetland08, aes(x = DateTime, y = WLTemp_c)) + geom_point()

plot_ly(data = WL_Wetland11, x = ~DateTime, y = ~WLPres_kpa)
plot_ly(data = WL_Wetland08, x = ~DateTime, y = ~WLTemp_c)
```
##  Plot
...
wetland <- "WL_Wetland10" #WL_Wetland01, WL_Wetland02
...
DateTime_BEFORE <- "2022-11-20 10:20:00"
DateTime_AFTER <- "2022-11-20 11:20:00"
#calculate average
ave <- wetland_data %>%
