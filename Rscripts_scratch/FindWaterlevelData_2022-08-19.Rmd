...
ggplot(data = WL_Wetland04, aes(x = DateTime, y = WLPres_kpa)) + geom_point()
plot_ly(data = WL_Wetland01, x = ~DateTime, y = ~WLPres_kpa)
plot_ly(data = WL_Wetland11, x = ~DateTime, y = ~WLTemp_c)
```
##  Plot
...
date <- "2022-10-19"
>>>>>>> 747405b09cc8f74f3b990b1540935f27ae60d0ab
