...
ggplot(data = WL_Wetland02, aes(x = DateTime, y = WLPres_kpa)) + geom_point()
ggplot(data = WL_Wetland02, aes(x = DateTime, y = WLTemp_c)) + geom_point()

plot_ly(data = WL_Wetland02, x = ~DateTime, y = ~WLPres_kpa)
...
wetland <- "WL_Wetland07" # example: WL_Wetland01, WL_Wetland02
...
DateTime_BEFORE <- "2022-12-02 12:30:00"
DateTime_AFTER <- "2022-12-02 13:00:00"
#calculate average
ave <- wetland_data %>%
