...
wetland <- "WL_Wetland06" # example: WL_Wetland01, WL_Wetland02
...
DateTime_BEFORE <- "2022-10-15 11:00:00"
DateTime_AFTER <- "2022-10-15 12:30:00"
#calculate average
ave <- wetland_data %>%
  ...
  summarize(WaterlLevel_mean = mean(WaterLevel_m, na.rm=TRUE),
