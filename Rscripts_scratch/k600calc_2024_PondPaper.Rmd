...
df <- read.csv(here::here("Wetlands/Wetland_df_MERGE_2024-04-14.csv"))%>%
  select(Site,DateTime,Date,
         ...
         PrecipAccuDay_mm,PrecipAccu_mm_PreviousDay,precip_mm_ave2,Precip_mm_ave7, solarrad_W_m2,solarrad_Wm2_daymean,windspeed_m_s, winddirecion)
...
df$Sc_ch4 <- 1897.8 + -114.28*df$Watertemp_c + 32902*(df$Watertemp_c)^2 + .039061*(df$Watertemp_c)^3
