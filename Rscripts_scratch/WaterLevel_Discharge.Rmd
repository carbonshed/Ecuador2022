...
All_WL <- rbind(WL_01,WL_02,WL_03,WL_Well01)
...
Baro <- Baro%>%filter(DateTime > as.POSIXct("2022-03-15 13:30:00", tz = "UTC"))
...
Baro_corrected %>% filter(DateTime == as.POSIXct("2022-06-07 10:40:00", tz = "UTC") &
                            Station == "WL_01")
