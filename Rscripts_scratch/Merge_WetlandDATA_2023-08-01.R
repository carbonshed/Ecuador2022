...
########
###This is if you've already run "Calc_K600_McDowell.R" in folder:Rscripts and want to add envirofactors
df <- read.csv(here::here("Wetlands/Wetland_df_2023-08-01.csv"))
df$X <- NULL
