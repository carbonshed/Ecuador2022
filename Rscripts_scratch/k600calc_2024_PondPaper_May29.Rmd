...
#All samples
the previous data set is the average. This data set is an analysis of variation.
...
#bind 
all_df <- rbind(summer_df,fall_df)
...
#write.csv(all_df,here::here("ProcessedData/All_CH4_samples_May29.csv"))
...
#write.csv(df_CO2,here::here("ProcessedData/All_CO2_samples_May29.csv"))
```
