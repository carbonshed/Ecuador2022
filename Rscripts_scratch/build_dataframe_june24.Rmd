...
df_summary_full <- full_join(CO2_summary_2,CH4_summary%>%select(!n)%>%select(!Watertemp_c)%>%select(!AirPress_kpa),by=c("New.Name","Date"))
...
df_summary_full_2 <- df_summary_full%>%
  select(New.Name,Date,Watertemp_c,AirPress_kpa,air_pressure_atm,
